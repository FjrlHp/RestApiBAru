package com.example.restapipertemuan9.adapter
...
class HomeAdapter(private var dataMahasiswa : List<DataMahasiswa>) : RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.cardView.setOnClickListener{
            ...
            Navigation.findNavController(it).navigate(com.example.restapipertemuan9.R.id.action_homeFragment_to_detailFragment,
                bundle)
        }
    }
}